  ...
  "questions": [
    {
      ...
      "explanation": "<p>Answer A is pretty strong, shows understanding and a personal commitment. However, the suggestion that things may yet ‘escalate’ may be alarming and it’s a little early to be taking ‘personal charge’ of a technical situation needing a strong team to resolve it. </p> <p> Answer B is long but shows command of detail and describes the actions you’re taking. It comes across as in-control and open about what has happened. It also underlines that your primary goal is the welfare of customers, and that they are your primary audience for information. </p> <p>Answer C is a weak answer, which doesn’t suggest you have control over the situation. While appealing for patience is important, it would have more credibility if you gave more detail about what you are doing and why the investigation needs time.</p>",
      "point": "20"
    },
  ],
