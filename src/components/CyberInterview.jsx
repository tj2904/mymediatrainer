  ...
  "questions": [
    {
      ...
      "messageForIncorrectAnswer": "Answer C is a weak answer, which doesn’t suggest you have control over the situation. While appealing for patience is important, it would have more credibility if you gave more detail about what you are doing and why the investigation needs time.",
    ...
    {
      "question": "Why has it taken you so long to get on top of the situation? I mean surely you know what’s happened and how to fix it by this point? Was this human error or are you the victims of  some kind of cyber attack?",
      "questionType": "text",
      "questionPic": "", // if you need to display Picture in Question
      "answerSelectionType": "single",
      "answers": [
      ...
      "correctAnswer": "3",
      "messageForCorrectAnswer": "Answer C is the strongest answer here, talking about the specific actions you’ve taken and your urgent response. It also explains constructively why you won’t be drawn into speculation.",
      "explanation": "Answer A doesn’t suggest you have control of the situation yet, and makes it seem like you’re behind the curve.            Answer B speculates about the cyberattack possibility and doesn’t give the impression of a leader who is on top of the detail of the situation.      Answer C is the strongest answer here, talking about the specific actions you’ve taken and your urgent response. It also explains constructively why you won’t be drawn into speculation.",
      "point": "20"
    },

        {
      "question": "So what do you say to customers who are seeing their accounts emptied by criminals as a result of this? Will you be taking this opportunity to apologise to your customers?",
      "questionType": "text",
      "questionPic": "", // if you need to display Picture in Question
      "answerSelectionType": "single",
      "answers": [
